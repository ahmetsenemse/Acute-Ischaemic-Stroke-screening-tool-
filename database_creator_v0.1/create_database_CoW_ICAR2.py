...
inlet=np.array([[1,'Q',0,0],[2,'B',1,3],[3,'B',1,2],[4,'B',2,5],[5,'B',2,4],[6,'B',3,7],
                 ...
                 [45,'C',11,20],[46,'C',12,33],[47,'B',45,50],[48,'B',49,108],[49,'B',47,86],
                 ...
                 [68,'B',48,130],[69,'B',68,76],[70,'B',69,71],[71,'B',69,70],[72,'B',70,73],[73,'B',70,72],
                 ...
                 [108,'B',49,48],[109,'B',108,129],[110,'B',109,116],[111,'J',110,110],[112,'B',111,115],[113,'B',112,114],
                 ...
                 [126,'B',118,119],[127,'B',117,118],[128,'J',116,117],[129,'B',108,109],[130,'B',48,68]
])
...
outlet=np.array([[1,'B',2,3],[2,'B',4,5],[3,'B',6,7],[4,'B',8,9],[5,'B',10,11],[6,'B',12,13],
                 ...
                 [45,'B',47,50],[46,'T',1,1],[47,'B',49,86],[48,'B',68,130],[49,'B',48,108],
...
for patient in range(0,1):
    ...
    while i < number:
        ...
        for j in [0]:        
            ...
            name='CoW_'+str(i)+'_ICAR2'+str(j)+'.in'
            f = open(name,"w")
