...
inlet=np.array([[1,'Q',0,0],[2,'B',1,3],[3,'B',1,2],[4,'B',2,5],[5,'B',2,4],[6,'B',3,7],
                 ...
                 [45,'C',11,20],[46,'B',33,130],[47,'B',45,50],[48,'B',46,68],[49,'B',47,86],
                 ...
                 [126,'B',118,119],[127,'B',117,118],[128,'J',116,117],[129,'B',108,109],[130,'B',33,46]
])


outlet=np.array([[1,'B',2,3],[2,'B',4,5],[3,'B',6,7],[4,'B',8,9],[5,'B',10,11],[6,'B',12,13],
                 [7,'B',16,17],[8,'W',0,0],[9,'B',14,15],[10,'W',0,0],[11,'C',20,45],[12,'T',1,1],
                 ...
                 [32,'B',33,34],[33,'B',46,130],[34,'B',35,36],[35,'B',37,38],[36,'W',0,0],[37,'B',39,40],
...
for patient in range(0,1):
    ...
    L=np.array([40,20,34,39,208,177,34,156,34,177,177,80,177,148,422,422,
                148,29,
    ...
    while i < number:
        ...
        for j in [0]:        
            ...
            name='CoW_'+str(i)+'_ICAR'+str(j)+'.in'
            f = open(name,"w")
