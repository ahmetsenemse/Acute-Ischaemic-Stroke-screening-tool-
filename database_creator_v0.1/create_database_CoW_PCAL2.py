...
inlet=np.array([[1,'Q',0,0],[2,'B',1,3],[3,'B',1,2],[4,'B',2,5],[5,'B',2,4],[6,'B',3,7],
                 ...
                 [45,'B',11,130],[46,'C',12,33],[47,'B',45,50],[48,'B',46,68],[49,'B',47,86],
                 ...
                 [126,'B',118,119],[127,'B',117,118],[128,'J',116,117],[129,'B',108,109],[130,'B',11,45]
])


outlet=np.array([[1,'B',2,3],[2,'B',4,5],[3,'B',6,7],[4,'B',8,9],[5,'B',10,11],[6,'B',12,13],
                 [7,'B',16,17],[8,'W',0,0],[9,'B',14,15],[10,'W',0,0],[11,'B',45,130],[12,'C',33,46],
                 [13,'W',0,0],[14,'C',17,18],[15,'W',0,0],[16,'W',0,0],[17,'C',14,18],[18,'B',19,32],
                 
                 [19,'B',20,21],[20,'T',1,1],[21,'B',22,23],[22,'B',24,25],[23,'W',0,0],[24,'B',26,27],
...
for patient in range(0,1):
    ...
    while i < number:
        ...
        for j in [0]:        
            ...
            name='CoW_'+str(i)+'_PCAL2'+str(j)+'.in'
            f = open(name,"w")
