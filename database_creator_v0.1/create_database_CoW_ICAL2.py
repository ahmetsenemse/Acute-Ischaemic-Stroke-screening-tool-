...
inlet=np.array([[1,'Q',0,0],[2,'B',1,3],[3,'B',1,2],[4,'B',2,5],[5,'B',2,4],[6,'B',3,7],
                 ...
                 [45,'C',11,20],[46,'C',12,33],[47,'B',49,86],[48,'B',46,68],[49,'B',48,108],
                 
                 [50,'B',47,130],[51,'B',50,58],[52,'B',51,53],[53,'B',51,52],[54,'B',52,55],[55,'B',52,54],
                 ...
                 [86,'B',49,47],[87,'B',86,107],[88,'B',87,94],[89,'J',88,88],[90,'B',89,93],[91,'B',90,92],
                 ...
                 [108,'B',48,49],[109,'B',108,129],[110,'B',109,116],[111,'J',110,110],[112,'B',111,115],[113,'B',112,114],
                 ...
                 [126,'B',118,119],[127,'B',117,118],[128,'J',116,117],[129,'B',108,109],[130,'B',47,50]
])
...
outlet=np.array([[1,'B',2,3],[2,'B',4,5],[3,'B',6,7],[4,'B',8,9],[5,'B',10,11],[6,'B',12,13],
                 ...
                 [45,'T',1,1],[46,'B',48,68],[47,'B',50,130],[48,'B',49,108],[49,'B',47,86],
...
for patient in range(0,1):
    ...
    L=np.array([40,20,34,39,208,177,34,156,34,177,177,177,177,148,422,422,
                ...
                43,43,80,50,20,20,112,102,5,5,5,5,5,5,84,84,70,56,41,41,21,7,2
    ...
    while i < number:
        ...
        for j in [0]:        
            ...
            name='CoW_'+str(i)+'_ICAL2'+str(j)+'.in'
            f = open(name,"w")
